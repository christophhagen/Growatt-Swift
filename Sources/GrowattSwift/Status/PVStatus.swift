...
public struct PVStatus {

    public struct PVInstance: Equatable {
        ...
        /** Energy today (kWh) */
        public let energyToday: Float

        /** PV 1 Energy total (kWh) */
        public let energyTotal: Float
    }

    public let pv1: PVInstance

    public let pv2: PVInstance

    /** Fan speed of MPPT Charger (%) */
    public let fanSpeedOfMpptCharger: Int
...
extension PVStatus: CustomStringConvertible {
